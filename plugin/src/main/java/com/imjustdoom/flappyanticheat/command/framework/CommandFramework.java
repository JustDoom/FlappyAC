...
public class CommandFramework implements CommandExecutor {
    ...
    public boolean handleCommand(CommandSender sender, Command cmd, String label, String[] args) {
        for (int i = args.length; i >= 0; i--) {
            ...
            if (this.commandMap.containsKey(cmdLabel)) {
                ...
                com.imjustdoom.flappyanticheat.command.framework.Command command = method.<com.imjustdoom.flappyanticheat.command.framework.Command>getAnnotation(com.imjustdoom.flappyanticheat.command.framework.Command.class);
    ...
    public void registerCommands(Object obj) {
        for (Method m : obj.getClass().getMethods()) {
            if (m.getAnnotation(com.imjustdoom.flappyanticheat.command.framework.Command.class) != null) {
                com.imjustdoom.flappyanticheat.command.framework.Command command = m.<com.imjustdoom.flappyanticheat.command.framework.Command>getAnnotation(com.imjustdoom.flappyanticheat.command.framework.Command.class);
    ...
    public void registerCommand(com.imjustdoom.flappyanticheat.command.framework.Command command, String label, Method m, Object obj) {
