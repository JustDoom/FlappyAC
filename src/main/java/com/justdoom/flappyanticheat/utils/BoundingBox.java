...
public class BoundingBox {
    ...
    public BoundingBox(final Player data) {
        this.minX = data.getLocation().getX() - 0.3D;
        this.minY = data.getLocation().getY();
        this.minZ = data.getLocation().getZ() - 0.3D;
        this.maxX = data.getLocation().getX() + 0.3D;
        this.maxY = data.getLocation().getY() + 1.8D;
        this.maxZ = data.getLocation().getZ() + 0.3D;
    }
